...
''' stack overflow, textbook, tensorflow doc, and class code helped here'''
...
#tensor flow text book and some stack overflow
def train_network():
    pictures = os.listdir(full_path + '/trainsymbols/')
    ...
    for card in sorted_pictures:
        ...
        img = imread(full_path + '/trainsymbols/' + card)
